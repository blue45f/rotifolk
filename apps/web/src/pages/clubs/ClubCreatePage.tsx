    ...
    <main className={styles.page}>
      <div className="container">
        ...
        <form className={styles.formNarrow} onSubmit={submit} noValidate>
          ...
          <fieldset className={styles.visibilityGroup}>
            <legend className={styles.fieldLabel}>공개 설정</legend>
          ...
          <div className={styles.formActions}>
            <Button type="submit" isLoading={createClub.isPending} disabled={createClub.isPending}>
              클럽 만들기
            </Button>
